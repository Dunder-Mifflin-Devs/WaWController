...
const reviewRoutes= require('./microServices/ReviewRatingsService/reviewRatingsRoutes')
const userMgmtRoutes= require('./microServices/WaWuserManagement/userRoutes/userRoutes');
const mediaRoutes= require('./microServices/MediaService/mediaRoutes/mediaRoutes')
...
// app.use("/", mainRoutes);
app.use('/review', ensureAuth(), reviewRoutes);
app.use('/user', ensureAuth(), userMgmtRoutes);
app.use('/media', ensureAuth(), mediaRoutes);
